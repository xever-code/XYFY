...
b = st.sidebar.number_input('NIHSS', min_value=0.0, max_value=2000.0, value=0)
c = st.sidebar.number_input('Neu-Z', min_value=0.0, max_value=2000.0, value=1783.9)
d = st.sidebar.number_input('Lym-X', min_value=0.00, max_value=2000.00, value=91.2)
e = st.sidebar.number_input('Lym-Z', min_value=0.00, max_value=2000.00, value=940.5)
f = st.sidebar.number_input('Mon-Y', min_value=0, max_value=2000, value=890.9)
g = st.sidebar.number_input('Mon-Z', min_value=0.0, max_value=2000.0, value=1252)
h = st.sidebar.number_input('ALT', min_value=0.00, max_value=2000.00, value=13)
i = st.sidebar.number_input('SUA', min_value=0.00, max_value=2000.00, value=343)
j = st.sidebar.number_input('PHR', min_value=0.000, max_value=2000.000, value=219.35)
