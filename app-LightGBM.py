...
# Input bar 1
a = st.sidebar.number_input('Age', min_value=0, max_value=150, value=55)
b = st.sidebar.number_input('NIHSS', min_value=0.0, max_value=200.0, value=68.4)
c = st.sidebar.number_input('Neu-Z', min_value=0.0, max_value=200.0, value=39.8)
d = st.sidebar.number_input('Lym-X', min_value=0.00, max_value=1500.00, value=18.70)
e = st.sidebar.number_input('Lym-Z', min_value=0.00, max_value=200.00, value=25.80)
f = st.sidebar.number_input('Mon-Y', min_value=0, max_value=200, value=144)
g = st.sidebar.number_input('Mon-Z', min_value=0.0, max_value=100.0, value=16.7)
h = st.sidebar.number_input('ALT', min_value=0.00, max_value=100.00, value=0.10)
i = st.sidebar.number_input('SUA', min_value=0.00, max_value=100.00, value=1.10)
j = st.sidebar.number_input('PHR', min_value=0.000, max_value=400000.000, value=102.850)
k = st.sidebar.number_input('UHR', min_value=0.00, max_value=100.00, value=0.10)
l = st.sidebar.number_input('TyG-BMI', min_value=0.00, max_value=100.00, value=1.10)
